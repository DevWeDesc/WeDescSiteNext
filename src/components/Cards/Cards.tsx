...
export const Cards = ({
  ...
  return (
    <div className="bg-blue-500 w-[100%] h-[96%] lg:h-[800px] lg:bg-inherit  lg:w-[23%] rounded-[13px] flex relative lg:backdrop-brightness-125 hover:scale-105 transition-[10s]">
      <Image
        src={cloud}
