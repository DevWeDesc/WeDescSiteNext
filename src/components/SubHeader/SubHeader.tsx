    ...
    >
      ...
      <div className="hidden lg:flex absolute w-full px-[7.7%] pt-[5%] 2xl:px-[2.5%] 2xl:pt-[8%] max-w-[1460px]">
        <div className="absolute flex items-start flex-col lg:gap-5">
          ...
          <a href="#Plans">
            <button className="absolute w-[250px] 2xl:left-[102px] top-[180px] lg:left-[122px] px-[16px] rounded-sm flex items-center gap-[5.05px] h-[44px] text-white bg-[#FECC09] transition-colors hover:bg-[#e3b600]">
