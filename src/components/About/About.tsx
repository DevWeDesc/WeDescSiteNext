    ...
    <div className="w-full">
      ...
      <div className="flex flex-col justify-between w-full">
        ...
        <Image
          alt=""
          src={LineImage}
          className="w-screen absolute md:pt-[940px] pt-[1005px] z-[-2] lg:hidden"
        ></Image>
        <Image
          alt=""
          src={ImageMobile}
          className="w-screen absolute md:pt-[960px] pt-[1025px] z-[-2] lg:hidden"
        ></Image>
        <Image
          alt=""
          src={ImageMobile}
          className="w-screen absolute pt-[2600px] z-[-2] lg:hidden"
        ></Image>
        <Image
          alt=""
          src={ImageMobile}
          className="w-screen absolute pt-[4250px] z-[-2] lg:hidden"
        ></Image>
        <Image
          alt=""
          src={ImageMobile}
